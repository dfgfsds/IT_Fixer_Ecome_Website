    ...
    return (
        <>
            <style dangerouslySetInnerHTML={{
                __html: `
                .cpc-sec { padding: 88px 0; position: relative; overflow: hidden; background: #0a0c10; font-family: inherit; }
                .cpc-sec-alt { background: #0b0e13; }
                .cpc-sec-alt2 { background: #0f1522; }

                .cpc-eyebrow { display: inline-flex; align-items: center; gap: 8px; font-size: 14px; font-weight: 600; letter-spacing: 3px; color: #cbfe1c; text-transform: uppercase; margin-bottom: 14px; }
                .cpc-eyebrow::before { content: ''; width: 24px; height: 2px; background: #cbfe1c; }

                h2.cpc-sh { font-size: clamp(28px, 4.5vw, 48px); color: #f0f4ff; line-height: 1.15; font-weight: 700; margin-bottom: 16px; }
                h2.cpc-sh span { background: linear-gradient(90deg, #36fe1cff, #cbfe1c); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; }

                .cpc-lead-p { font-size: 16px; color: #8899b4; line-height: 1.7; max-width: 600px; }
                ...
                /* Brands */
                .cpc-brand-pill { display: flex; align-items: center; gap: 14px; background: #111520; border: 1px solid #1d2535; border-radius: 12px; padding: 16px 20px; transition: border-color 0.3s, transform 0.2s; cursor: default; }
                .cpc-brand-pill:hover { border-color: rgba(54, 254, 28, 0.4); transform: translateX(6px); }
                .cpc-brand-pill .bp-dot { width: 10px; height: 10px; border-radius: 50%; background: #cbfe1c; flex-shrink: 0; }
                .cpc-brand-pill h6 { font-size: 16px; font-weight: 600; color: #dde8ff; margin: 0; }
                .cpc-brand-pill span { font-size: 13px; color: #8899b4; margin-left: auto; }

                /* Why IT Fixer */
                .cpc-wif-item { display: flex; gap: 16px; align-items: flex-start; padding: 24px; background: #111520; border: 1px solid #1d2535; border-radius: 12px; transition: border-color 0.3s; height: 100%; cursor: default; }
                .cpc-wif-item:hover { border-color: rgba(54, 254, 28, 0.35); }
                .cpc-wif-num { font-size: 28px; font-weight: 700; color: rgba(203, 254, 28, 0.3); min-width: 36px; line-height: 1; margin-top: 2px; }
                .cpc-wif-body h6 { font-size: 18px; font-weight: 600; color: #f0f4ff; margin-bottom: 6px; }
                .cpc-wif-body p { font-size: 15px; color: #8899b4; margin: 0; line-height: 1.6; }

                /* Use Case Tabs */
                .cpc-use-tab-wrap { background: #111520; border: 1px solid #1d2535; border-radius: 16px; overflow: hidden; position: relative; z-index: 1; }
                .cpc-use-tabs { display: flex; border-bottom: 1px solid #1d2535; }
                .cpc-use-tab-btn { flex: 1; padding: 18px; font-size: 16px; font-weight: 600; color: #8899b4; background: transparent; border: none; cursor: pointer; transition: color 0.2s, background 0.2s; letter-spacing: 0.5px; text-transform: uppercase; border-bottom: 2px solid transparent; }
                .cpc-use-tab-btn.active { color: #cbfe1c; background: rgba(54, 254, 28, 0.05); border-bottom: 2px solid #cbfe1c; }
                ...
                .cpc-use-tag { display: inline-flex; align-items: center; gap: 6px; background: rgba(54, 254, 28, 0.08); border: 1px solid rgba(54, 254, 28, 0.18); border-radius: 100px; padding: 6px 14px; font-size: 13px; color: #cbfe1c; margin: 4px; font-weight: 500; }

                /* Compare Table */
                .cpc-compare-table { width: 100%; border-collapse: collapse; }
                .cpc-compare-table th { font-size: 16px; font-weight: 600; padding: 16px 20px; text-align: left; border-bottom: 1px solid #1d2535; }
                .cpc-compare-table th.custom-col { color: #cbfe1c; background: rgba(54, 254, 28, 0.06); }
                .cpc-compare-table th.brand-col { color: #f0f4ff; background: rgba(255, 255, 255, 0.02); }
                .cpc-compare-table th.label-col { color: #8899b4; background: #111520; }
                .cpc-compare-table td { padding: 16px 20px; font-size: 15px; border-bottom: 1px solid #1d2535; vertical-align: middle; }
                .cpc-compare-table td.custom-col { color: #f0f4ff; background: rgba(54, 254, 28, 0.03); }
                .cpc-compare-table td.brand-col { color: #8899b4; background: rgba(255, 255, 255, 0.01); }
                .cpc-compare-table td.label-col { color: #dde8ff; font-weight: 500; background: #111520; }
                ...
                .cpc-process-step::after { content: ''; position: absolute; left: 24px; top: 52px; bottom: 0; width: 2px; background: linear-gradient(180deg, rgba(54, 254, 28, 0.3), transparent); }
                .cpc-process-step:last-child::after { display: none; }
                .cpc-ps-circle { width: 50px; height: 50px; min-width: 50px; border-radius: 50%; background: rgba(54, 254, 28, 0.1); border: 2px solid rgba(54, 254, 28, 0.4); display: flex; align-items: center; justify-content: center; font-size: 18px; font-weight: 700; color: #cbfe1c; z-index: 1; }
                .cpc-ps-body h5 { font-size: 18px; font-weight: 600; color: #f0f4ff; margin-bottom: 6px; }
                .cpc-ps-body p { font-size: 15px; color: #8899b4; margin: 0; line-height: 1.6; }

                /* Pricing */
                .cpc-price-card { background: #111520; border: 1px solid #1d2535; border-radius: 16px; padding: 32px 24px; height: 100%; position: relative; transition: border-color 0.3s, transform 0.25s; overflow: hidden; cursor: default; }
                .cpc-price-card.featured { border-color: rgba(54, 254, 28, 0.5); background: linear-gradient(145deg, #111520 0%, #0c1412 100%); }
                ...
                .cpc-price-card:hover { transform: translateY(-5px); border-color: rgba(54, 254, 28, 0.4); }
                .cpc-price-card h5 { font-size: 18px; font-weight: 600; color: #dde8ff; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 16px; }
                .cpc-price-card .price-val { font-size: 42px; font-weight: 700; color: #cbfe1c; line-height: 1; margin-bottom: 8px; }
                .cpc-price-card .price-sub { font-size: 14px; color: #8899b4; margin-bottom: 24px; }
                ...
                .cpc-price-card ul li { font-size: 15px; color: #8899b4; display: flex; align-items: center; gap: 10px; }
                .cpc-price-card ul li svg { color: #cbfe1c; }

                /* Support Row */
                .cpc-support-row { display: flex; align-items: center; gap: 16px; padding: 18px; background: #111520; border: 1px solid #1d2535; border-radius: 12px; margin-bottom: 12px; transition: border-color 0.3s; cursor: default; }
                .cpc-support-row:hover { border-color: rgba(54, 254, 28, 0.4); transform: translateX(4px); }
                .cpc-support-row .sr-icon { width: 44px; height: 44px; min-width: 44px; border-radius: 10px; background: rgba(54, 254, 28, 0.08); border: 1px solid rgba(54, 254, 28, 0.15); display: flex; align-items: center; justify-content: center; }
                .cpc-support-row .sr-icon svg { color: #cbfe1c; }
                .cpc-support-row h6 { font-size: 16px; font-weight: 600; color: #f0f4ff; margin: 0 0 4px; }
                .cpc-support-row p { font-size: 14px; color: #8899b4; margin: 0; }

                /* Area Chip */
                .cpc-area-chip { display: inline-flex; align-items: center; gap: 8px; background: #111520; border: 1px solid #1d2535; border-radius: 10px; padding: 12px 20px; font-size: 15px; font-weight: 600; color: #dde8ff; margin: 6px; transition: border-color 0.25s, color 0.25s; cursor: default; }
                .cpc-area-chip:hover { border-color: rgba(54, 254, 28, 0.4); color: #cbfe1c; }
                
                /* FAQ Section */
                .cpc-faq-item { background: #111520; border: 1px solid #1d2535; border-radius: 12px; padding: 24px; height: 100%; transition: border-color 0.3s; cursor: default; }
                .cpc-faq-item:hover { border-color: rgba(54, 254, 28, 0.4); }
                .cpc-faq-q { font-size: 17px; font-weight: 600; color: #f0f4ff; margin-bottom: 12px; display: flex; align-items: flex-start; gap: 12px; }
                .cpc-faq-q .q-icon { color: #cbfe1c; flex-shrink: 0; margin-top: 2px; }
                .cpc-faq-a { font-size: 15px; color: #8899b4; margin: 0; line-height: 1.6; padding-left: 32px; }

                /* CTA Section */
                .cpc-cta-section { background: #0f1522; border-top: 1px solid #1d2535; border-bottom: 1px solid #1d2535; padding: 80px 0; position: relative; overflow: hidden; }
                ...
                .cpc-cta-feature { display: flex; align-items: center; gap: 10px; font-size: 15px; color: #8899b4; margin-bottom: 12px; }
                .cpc-cta-feature svg { color: #cbfe1c; }
                ...
                <div className="container">
                    <div className="row align-items-center g-5">
                        <div className="col-lg-5">
                            <div className="cpc-eyebrow">Trusted Hardware</div>
                            <h2 className="cpc-sh">Top Brands We Use in <span>Custom PC Builds</span></h2>
                            <div className="cpc-divider-line"></div>
                            <p className="cpc-lead-p">At IT Fixer, we source only trusted global brands — ensuring high performance, durability, and full warranty support on every component.</p>
                            <div className="mt-4 p-3" style={{ background: 'rgba(54, 254, 28, 0.05)', border: '1px solid rgba(54, 254, 28, 0.15)', borderRadius: '10px' }}>
                                <p style={{ fontSize: '14px', color: '#8899b4', margin: 0, display: 'flex', gap: '8px' }}>
                                    <ShieldCheck color="#cbfe1c" size={20} className="flex-shrink-0" />
            ...
            <section className="cpc-sec cpc-dot-bg">
                <div className="container position-relative" style={{ zIndex: 1 }}>
                    <div className="cpc-sec-center mb-5">
                        <div className="cpc-eyebrow justify-content-center">Our Edge</div>
                        <h2 className="cpc-sh">Why IT Fixer is the <span>Best Custom PC Builder</span> in Chennai</h2>
                        <div className="cpc-divider-line"></div>
                        <p className="cpc-lead-p">One of the top-rated custom PC builders in Chennai — trusted by gamers, creators, and professionals across Tamil Nadu.</p>
                    </div>
            ...
            <section className="cpc-sec cpc-sec-alt2">
                <div className="container">
                    <div className="cpc-sec-center mb-5">
                        <div className="cpc-eyebrow justify-content-center">Use Case Builds</div>
                        <h2 className="cpc-sh">Gaming PC & <span>Workstation Builds</span> in Chennai</h2>
                        <div className="cpc-divider-line"></div>
                    </div>
                            ...
                            <div className="cpc-use-tab-content active">
                                <div className="row align-items-center g-4">
                                    <div className="col-lg-6">
                                        <h3 style={{ fontSize: '32px', fontWeight: 700, color: '#f0f4ff', marginBottom: '12px' }}>
                                            Gaming PC Build <span style={{ color: '#cbfe1c' }}>Chennai</span>
                                        </h3>
                                        <p style={{ fontSize: '15px', color: '#8899b4', lineHeight: 1.75, marginBottom: '20px' }}>
                                    ...
                                    <div className="col-lg-6">
                                        <div style={{ background: 'rgba(54, 254, 28, 0.04)', border: '1px solid rgba(54, 254, 28, 0.12)', borderRadius: '12px', padding: '24px' }}>
                                            <p style={{ fontSize: '13px', color: '#8899b4', marginBottom: '16px', textTransform: 'uppercase', letterSpacing: '1px', fontWeight: 600 }}>Build Tiers</p>
                                            <div className="d-flex flex-column gap-3">
                                                <div className="d-flex justify-content-between align-items-center p-3" style={{ background: '#0a0c10', borderRadius: '8px', border: '1px solid #1d2535' }}><span style={{ fontSize: '15px', color: '#f0f4ff', fontWeight: 600 }}>Budget Gaming</span><span style={{ color: '#cbfe1c', fontSize: '20px', fontWeight: 700 }}>₹40,000+</span></div>
                                                <div className="d-flex justify-content-between align-items-center p-3" style={{ background: '#0a0c10', borderRadius: '8px', border: '1px solid rgba(54, 254, 28, 0.3)' }}><span style={{ fontSize: '15px', color: '#f0f4ff', fontWeight: 600 }}>Mid-Range Gaming</span><span style={{ color: '#cbfe1c', fontSize: '20px', fontWeight: 700 }}>₹60K–90K</span></div>
                                                <div className="d-flex justify-content-between align-items-center p-3" style={{ background: '#0a0c10', borderRadius: '8px', border: '1px solid #1d2535' }}><span style={{ fontSize: '15px', color: '#f0f4ff', fontWeight: 600 }}>High-End Gaming</span><span style={{ color: '#cbfe1c', fontSize: '20px', fontWeight: 700 }}>₹1,00,000+</span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        {activeTab === 'workstation' && (
                            <div className="cpc-use-tab-content active">
                                <div className="row align-items-center g-4">
                                    ...
                                    <div className="col-lg-6">
                                        <div style={{ background: 'rgba(54, 254, 28, 0.04)', border: '1px solid rgba(54, 254, 28, 0.12)', borderRadius: '12px', padding: '24px' }}>
                                            <p style={{ fontSize: '13px', color: '#8899b4', marginBottom: '16px', textTransform: 'uppercase', letterSpacing: '1px', fontWeight: 600 }}>Recommended Specs</p>
                                            <div className="d-flex flex-column gap-2">
                                                <div className="d-flex align-items-center gap-3 p-3" style={{ background: '#0a0c10', borderRadius: '8px', border: '1px solid #1d2535' }}><Cpu color="#cbfe1c" size={20} /><span style={{ fontSize: '14px', color: '#8899b4' }}>Intel Core i9 / AMD Ryzen 9</span></div>
                                                <div className="d-flex align-items-center gap-3 p-3" style={{ background: '#0a0c10', borderRadius: '8px', border: '1px solid #1d2535' }}><MemoryStick color="#cbfe1c" size={20} /><span style={{ fontSize: '14px', color: '#8899b4' }}>64GB – 128GB DDR5 RAM</span></div>
                                                <div className="d-flex align-items-center gap-3 p-3" style={{ background: '#0a0c10', borderRadius: '8px', border: '1px solid #1d2535' }}><MonitorPlay color="#cbfe1c" size={20} /><span style={{ fontSize: '14px', color: '#8899b4' }}>NVIDIA RTX 4070 / 4080 / 4090</span></div>
                                                <div className="d-flex align-items-center gap-3 p-3" style={{ background: '#0a0c10', borderRadius: '8px', border: '1px solid #1d2535' }}><HardDrive color="#cbfe1c" size={20} /><span style={{ fontSize: '14px', color: '#8899b4' }}>2TB NVMe SSD + HDD Storage</span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <section className="cpc-sec cpc-dot-bg">
                <div className="container position-relative" style={{ zIndex: 1 }}>
                    <div className="cpc-sec-center mb-5">
                        <div className="cpc-eyebrow justify-content-center">Comparison</div>
                        <h2 className="cpc-sh">Custom PC vs <span style={{ color: '#f0f4ff', background: 'none', WebkitBackgroundClip: 'unset', WebkitTextFillColor: 'unset' }}>Branded Desktop</span> — Which is Better?</h2>
                        <div className="cpc-divider-line"></div>
                        <p className="cpc-lead-p">A custom desktop computer in Chennai offers better flexibility, performance, and long-term value compared to any off-the-shelf branded desktop.</p>
                    </div>
                    <div style={{ background: '#111520', border: '1px solid #1d2535', borderRadius: '14px', overflow: 'hidden' }} className="table-responsive">
            ...
            <section className="cpc-sec cpc-sec-alt2">
                <div className="container">
                    <div className="row align-items-start g-5">
                        <div className="col-lg-5">
                            <div className="cpc-eyebrow">How It Works</div>
                            <h2 className="cpc-sh">Our Custom PC <span>Build Process</span></h2>
                            <div className="cpc-divider-line"></div>
                            <p className="cpc-lead-p">From your first consultation to final delivery — a streamlined, transparent process designed to deliver the perfect PC every time.</p>
                            <div className="mt-4 d-flex gap-4">
                                <div><div style={{ fontSize: '38px', fontWeight: 700, color: '#cbfe1c', lineHeight: 1 }}>500+</div><div style={{ fontSize: '11px', letterSpacing: '1.5px', color: '#8899b4', textTransform: 'uppercase', marginTop: '6px' }}>Builds Completed</div></div>
                                <div><div style={{ fontSize: '38px', fontWeight: 700, color: '#cbfe1c', lineHeight: 1 }}>99%</div><div style={{ fontSize: '11px', letterSpacing: '1.5px', color: '#8899b4', textTransform: 'uppercase', marginTop: '6px' }}>Satisfaction Rate</div></div>
                            </div>
                        </div>
                        <div className="col-lg-7">
            ...
            <section className="cpc-sec cpc-dot-bg">
                <div className="container position-relative" style={{ zIndex: 1 }}>
                    <div className="cpc-sec-center mb-5">
                        <div className="cpc-eyebrow justify-content-center">Transparent Pricing</div>
                        <h2 className="cpc-sh">Custom PC Build in <span>Chennai Price</span></h2>
                        <div className="cpc-divider-line"></div>
                        <p className="cpc-lead-p">Pricing depends on configuration and performance needs. We provide transparent pricing with zero hidden charges.</p>
                    </div>
                    <div className="row g-4">
            ...
            <section className="cpc-sec cpc-sec-alt">
                <div className="container">
                    <div className="row align-items-center g-5">
                        <div className="col-lg-5">
                            <div className="cpc-eyebrow">Post-Build Support</div>
                            <h2 className="cpc-sh">After-Sales Support <span>& Warranty</span></h2>
                            <div className="cpc-divider-line"></div>
                            <p className="cpc-lead-p">At IT Fixer, we don't just build PCs — we support you long after delivery. Our after-sales team ensures your system runs smoothly for years.</p>
                            <div className="mt-4 p-3" style={{ background: 'rgba(54, 254, 28, 0.05)', border: '1px solid rgba(54, 254, 28, 0.2)', borderRadius: '10px' }}>
                                <p style={{ fontSize: '14px', color: '#cbfe1c', margin: 0, display: 'flex', gap: '8px' }}>
                                    <ShieldCheck color="#cbfe1c" size={20} className="flex-shrink-0" />
            ...
            <section className="cpc-sec cpc-dot-bg">
                <div className="container position-relative" style={{ zIndex: 1 }}>
                    <div className="cpc-sec-center mb-5">
                        <div className="cpc-eyebrow justify-content-center">Coverage</div>
                        <h2 className="cpc-sh">Custom PC Build <span>Service Areas</span></h2>
                        <div className="cpc-divider-line"></div>
                        <p className="cpc-lead-p">We provide custom PC build services across Chennai and all of Tamil Nadu. Looking for a custom PC build near you? IT Fixer has you covered.</p>
                    </div>
            ...
            <section className="cpc-sec cpc-sec-alt2">
                <div className="container">
                    <div className="cpc-sec-center mb-5">
                        <div className="cpc-eyebrow justify-content-center">Queries Answered</div>
                        <h2 className="cpc-sh">Frequently Asked Questions – <span>Custom PC Build in Chennai</span></h2>
                        <div className="cpc-divider-line"></div>
                    </div>
                    <div className="row g-4">
            ...
            {/* 10. FINAL CTA */}
            <section className="cpc-cta-section" style={{ background: "#0a0c10" }}>
                <div className="container">
                    <div className="row align-items-center g-5">
                        <div className="col-lg-7">
                            <div className="cpc-cta-badge"><span className="live-dot"></span>Now Accepting Builds</div>
                            <h2 className="cpc-sh" style={{ fontSize: 'clamp(30px, 5vw, 56px)' }}>Get Your Custom PC Build<br />in <span>Chennai Today</span></h2>
                            <p className="cpc-lead-p mb-4">Ready to build your dream PC? Contact IT Fixer for a free consultation, transparent pricing, and a system built exactly to your needs.</p>
                            ...
                            <div className="d-flex gap-3 flex-wrap">
                                <a href="/contact" className="cpc-btn-primary">Build My PC Now</a>
                                <a href="/shop" className="cpc-btn-outline">View Pricing</a>
                            </div>
                        </div>
                        <div className="col-lg-5">
                            <div style={{ background: '#111520', border: '1px solid #1d2535', borderRadius: '16px', padding: '32px' }}>
                                <p style={{ fontSize: '14px', fontWeight: 700, letterSpacing: '2px', color: '#8899b4', textTransform: 'uppercase', marginBottom: '20px' }}>Why Choose IT Fixer</p>
                                <div className="d-flex flex-column gap-3">
                                    <div className="d-flex align-items-center gap-3"><div style={{ width: '36px', height: '36px', borderRadius: '8px', background: 'rgba(54, 254, 28, 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}><Zap color="#cbfe1c" size={18} /></div><span style={{ fontSize: '15px', color: '#8899b4', fontWeight: 500 }}>Same-day quotation turnaround</span></div>
                                    <div className="d-flex align-items-center gap-3"><div style={{ width: '36px', height: '36px', borderRadius: '8px', background: 'rgba(54, 254, 28, 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}><Users color="#cbfe1c" size={18} /></div><span style={{ fontSize: '15px', color: '#8899b4', fontWeight: 500 }}>500+ satisfied customers</span></div>
                                    <div className="d-flex align-items-center gap-3"><div style={{ width: '36px', height: '36px', borderRadius: '8px', background: 'rgba(54, 254, 28, 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}><ShieldCheck color="#cbfe1c" size={18} /></div><span style={{ fontSize: '15px', color: '#8899b4', fontWeight: 500 }}>Component-level warranty</span></div>
                                    <div className="d-flex align-items-center gap-3"><div style={{ width: '36px', height: '36px', borderRadius: '8px', background: 'rgba(54, 254, 28, 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}><MapPin color="#cbfe1c" size={18} /></div><span style={{ fontSize: '15px', color: '#8899b4', fontWeight: 500 }}>Chennai-based with TN delivery</span></div>
                                    <div className="d-flex align-items-center gap-3"><div style={{ width: '36px', height: '36px', borderRadius: '8px', background: 'rgba(54, 254, 28, 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}><Banknote color="#cbfe1c" size={18} /></div><span style={{ fontSize: '15px', color: '#8899b4', fontWeight: 500 }}>EMI & flexible payment options</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
