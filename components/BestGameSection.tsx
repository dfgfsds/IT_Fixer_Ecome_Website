            ...
            <div className="container">
                <div className="section-title-area">
                    <div className="section-title mb-0">
                        <h6 className="subtitle tz-sub-tilte tz-sub-anim  text-uppercase tx-subTitle">our best games</h6>
                        <h2 className="tx-title sec_title  tz-itm-title tz-itm-anim">
                            Our High Regulation <br /> Games For You
                        </h2>
                    </div>
                    <a href="game.html" className="theme-btn style-2 wow fadeInUp" data-wow-delay=".5s">
                    ...
                    <div className="swiper-slide">
                        <div className="gt-gaming-card-item">
                            <div className="gt-gaming-image">
                                ...
                                <a href="game-details.html" className="icon">
                                    <i className="fa-solid fa-arrow-right"></i>
                                </a>
                                <div className="gt-gaming-content">
                                    <h6>metaverse</h6>
                                    <h3>
                                        <a href="game-details.html">Sweet revenge gameplay</a>
                                    </h3>
                                </div>
                            </div>
                        </div>
