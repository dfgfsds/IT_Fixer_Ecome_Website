...
export default function TestimonialSection() {
    ...
    const faqs = [
        {
            question: "1. Where can I find a reliable gaming PC builder in Chennai?",
            answer: "You can visit IT Fixer if you're looking for a reliable gaming PC build. The team helps you choose parts based on the games you play, your monitor resolution, FPS expectation and budget, instead of suggesting the same configuration for every customer."
        },
        {
            question: "2. Should I buy a gaming PC to stream games & make videos for Youtube?",
            answer: "Yes. A gaming and streaming PC requires a well-balanced system as the PC must run the game, recording software, webcam, microphone and live stream simultaneously. For newbies however IT Fixer can recommend a reputable gaming PC builder in chennai for regular streamers."
        },
        {
            question: "3. What type of PC is good for video editing?",
            answer: "For video editing, you need a good processor, enough RAM, fast SSD storage & a suitable graphics card. At IT Fixer, editing PCs are planned based on your work, such as reels, YouTube videos, wedding editing, product videos, 4K projects or studio work."
        },
        {
            question: "4. Do I need to buy a new PC, or can I upgrade my old one?",
            answer: "You may not always need a new PC. If your current system is still usable, upgrades like SSD, RAM, graphics card, cooling or power supply changes can improve performance. At IT Fixer, our computer store in Chennai offers reliable upgrade support to check your requirements and suggest whether upgrading or replacing makes more sense."
        },
        {
            question: "5. Does IT Fixer sell gaming pc parts & gaming laptops in chennai?",
            answer: "Yes. Along with custom PC assembling. IT Fixer also helps customers who are looking for gaming laptops. They also support those who need creator laptops or want to upgrade their computer with graphics cards. You can also find SSDs, RAM and motherboards there."
        },
        {
            question: "6. Why should you go to a computer store in chennai instead of buying parts online?",
            answer: "Online buying is useful, but custom PC build needs proper part matching. A wrong motherboard, weak power supply, poor airflow cabinet or low RAM choice can affect performance later. At a local shop like IT Fixer, you can discuss your usage directly and get guidance before spending money."
        }
    ];

    return (
        <section className="testimonial-section-2 section-padding pt-2 pb-5" style={{ backgroundColor: "#080808" }}>
            <div className="container">
                {/* Testimonial Row */}
                ...
                {/* FAQ Section Integrated Seamlessly at Bottom */}
                <div className="faq-section-wrapper mt-5 pt-4">
                    <div className="text-center mb-5">
                        <h6 className="subtitle text-uppercase tx-subTitle text-brand fw-bold mb-2" style={{ letterSpacing: "1.5px", color: "#C6FF00" }}>
                            FAQ
                        </h6>
                        <h2 className="tx-title text-uppercase text-white fw-bold display-6">
                        ...
                        <div className="col-xl-10">
                            <div className="faq-accordion-container">
                                {faqs.map((faq, idx) => {
                                    ...
                                    return (
                                        <div key={idx} className={`faq-item-box mb-3 ${isOpen ? "faq-active" : ""}`}>
                                            <h5
                                                className="faq-question-trigger d-flex justify-content-between align-items-center m-0 p-4"
                                                onClick={() => toggleFaq(idx)}
                                                style={{ cursor: "pointer", userSelect: "none" }}
                                            >
                                                <span>{faq.question}</span>
                                                <span className={`faq-icon-indicator ${isOpen ? "rotate-icon" : ""}`}>
                                                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M1 4.5L7 10.5L13 4.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                                    </svg>
                                                </span>
                                            </h5>
                                            <div className={`faq-answer-panel ${isOpen ? "panel-expanded" : ""}`}>
                                                <div
                                                    className="p-4 pt-0 text-muted-custom"
                                                    style={{
                                                        fontSize: "0.95rem",
                                                        lineHeight: "1.6",
            ...
            <style jsx>{`
                ...
                .faq-item-box:hover .faq-question-trigger {
                    color: #C6FF00;
                }
                .faq-icon-indicator {
                    color: #ffffff;
                ...
                .faq-item-box:hover .faq-icon-indicator {
                    color: #C6FF00;
                }
                .rotate-icon {
