    ...
    return (
        <div>
            ...
            <div id="smooth-content">
                ...
                <section className="leadership-sec" style={{ padding: '100px 0', background: '#0a0c10', position: 'relative', overflow: 'hidden' }}>
                    ...
                    <div className="container position-relative">
                        ...
                        <div className="row g-5">
                            ...
                            <div className="col-lg-6">
                                <div className="leader-profile" style={{ position: 'relative', paddingLeft: '30px', borderLeft: '2px solid rgba(203, 254, 28, 0.3)' }}>
                                    <div className="mb-4">
                                        <h3 className="text-white mb-1">Ramesh S</h3>
                                        <div style={{ display: 'inline-block', padding: '4px 12px', background: 'rgba(203, 254, 28, 0.1)', borderRadius: '4px', border: '1px solid rgba(203, 254, 28, 0.2)' }}>
                                    ...
                                    <div className="leader-bio" style={{ color: '#a0a0a0', lineHeight: '1.8' }}>
                                        ...
                                        <p className="mt-3 italic" style={{ borderLeft: '3px solid #cbfe1c', paddingLeft: '15px', fontStyle: 'italic' }}>"Under his guidance, IT Fixer is built on the principles of innovation, affordability, and exceptional customer experience, setting new standards in the gaming and editing PC industry."</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-lg-6">
                                <div className="leader-profile" style={{ position: 'relative', paddingLeft: '30px', borderLeft: '2px solid rgba(203, 254, 28, 0.3)' }}>
                                    <div className="mb-4">
                                        <h3 className="text-white mb-1">Subashini Kesavalu</h3>
                                        <div style={{ display: 'inline-block', padding: '4px 12px', background: 'rgba(203, 254, 28, 0.1)', borderRadius: '4px', border: '1px solid rgba(203, 254, 28, 0.2)' }}>
                                    ...
                                    <div className="leader-bio" style={{ color: '#a0a0a0', lineHeight: '1.8' }}>
                                        ...
                                        <p className="mt-3 italic" style={{ borderLeft: '3px solid #cbfe1c', paddingLeft: '15px', fontStyle: 'italic' }}>"With a focus on people, process, and performance, Subashini Kesavalu is instrumental in shaping IT Fixer into a reliable and professionally driven technology brand."</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                {/* MISSION & VISION - INTEGRATED DESIGN */}
                <section className="mission-vision-sec" style={{ padding: '60px 0 100px', background: '#0a0c10' }}>
                    <div className="container">
                        <div className="row g-4">
                            <div className="col-md-6">
                                <div className="mission-item-box" style={{ background: '#111520', padding: '40px', borderRadius: '30px', border: '1px solid #1d2535', height: '100%' }}>
                                    <div className="d-flex align-items-center gap-3 mb-4">
                                        <div style={{ width: '50px', height: '50px', background: 'linear-gradient(135deg, #cbfe1c 0%, #111520 100%)', borderRadius: '15px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                            <Target color="#000" size={24} />
                                        </div>
