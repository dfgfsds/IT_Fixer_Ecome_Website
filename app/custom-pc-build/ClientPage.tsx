            ...
            <div>
                <div id="smooth-content">
                                ...
                                <div className="row g-lg-4 align-items-center">
                                    ...
                                    <div className="col-lg-7 col-xl-6">
                                        <div className="about-content">
                                            ...
                                            <p className="about-text mt-2 wow fadeInUp" data-wow-delay=".5s">
                    ...
                    <div className="why-section">
                        <div className="container">
                            <div className="section-title text-center mb-5 w-100 mx-auto" style={{ position: 'relative', zIndex: 1, maxWidth: '800px' }}>
                                <h6 className="subtitle tz-sub-tilte tz-sub-anim text-uppercase tx-subTitle">Why Choose Us</h6>
                                <h2 className="tx-title sec_title tz-itm-title tz-itm-anim why-section-header">Why Choose <span>IT Fixer</span> for Custom PC Build in Chennai?</h2>
                                <p className="about-text wow fadeInUp mt-3" data-wow-delay=".5s">We combine technical expertise with premium hardware to deliver performance-driven custom PCs - built right, the first time.</p>
                            </div>

                            <div className="row justify-content-center g-4">
                                <div className="col-xxl-3 col-lg-4 col-md-6">
                                    <div className="why-feature-card h-100">
                    ...
                    <section style={{ backgroundColor: 'transparent', padding: '80px 24px 60px', position: 'relative', overflow: 'hidden' }}>
                                ...
                                <div className="row g-4 align-items-center flex-column-reverse flex-lg-row">
                                    <div className="col-lg-6">
                                        <div className="gt-top-feature-content">
                                            <div className="section-title mb-0">
                                                <h6 className="subtitle tz-sub-tilte tz-sub-anim text-uppercase tx-subTitle">Infinite Options</h6>
                                                <h2 className="tx-title sec_title  tz-itm-title tz-itm-anim">
                                                    Customize Every Component
                                                </h2>
                                                <p className="about-text wow fadeInUp mt-2" data-wow-delay=".5s">
                                            ...
                                            <div className="row mt-4">
                                                {[
                                                    ...
                                                    <div className="col-md-6 g-2 mb-4 wow fadeInUp" data-wow-delay={`${0.2 + idx * 0.1}s`} key={idx}>
                                                        <div className="d-flex align-items-start gap-3">
                                                            <div className="icon-box" style={{ width: '48px', height: '48px', background: '#1C1D20', borderRadius: '6px', color: "#cbfe1c", display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                                                {item.icon}
                                                            </div>
                                                            <div>
                                                                <h3 className="text-white mb-1" style={{ fontSize: '16px', textTransform: 'uppercase', fontWeight: 600, color: '#fff' }}>{item.title}</h3>
                                                                <p className="mb-0" style={{ fontSize: "14px", lineHeight: "1.6" }}>{item.desc}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ))}
